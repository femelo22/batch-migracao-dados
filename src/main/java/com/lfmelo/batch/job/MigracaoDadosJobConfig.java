...
public class MigracaoDadosJobConfig {
	...
	/**
	 * Podemos paralelizar os Steps quando eles podem ser executados de forma independente
	 * FLOW - vai criar nossa execucao de Steps paralelos
	 * slipt - Ele vai dividir as tarefas, para executarem paralelamente
	 */
